...
WHERE brand = 'Daikin' AND name ILIKE '%emura%' AND name NOT ILIKE '%FTXJ50AS%' AND name NOT ILIKE '%FTXJ50AB%' AND name NOT ILIKE '%FTXJ25AB%' AND name NOT ILIKE '%FTXJ35AB%';
...
WHERE brand = 'Daikin' AND name ILIKE '%sensira%';
