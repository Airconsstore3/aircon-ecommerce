  ...
  useEffect(() => {
    const fetchData = async () => {
      const [productData, categoriesData] = await Promise.all([
        ...
        supabase.from("categories").select("id, name").eq("is_published", true).order("name"),
      ]);
      ...
      if (productData.data) {
        setFormData({
          ...
          btu_range: productData.data.btu_range?.toString() || "",
          price_zar: productData.data.price_zar.toString(),
          sale_price_zar: productData.data.sale_price_zar?.toString() || "",
          stock_count: productData.data.stock_count,
          low_stock_threshold: productData.data.low_stock_threshold,
          is_published: productData.data.is_published,
          is_enquiry_only: productData.data.is_enquiry_only,
          is_featured: productData.data.is_featured,
          is_sale: productData.data.is_sale,
          is_deal: productData.data.is_deal,
          meta_title: productData.data.meta_title || "",
          meta_description: productData.data.meta_description || "",
        });
        if (productData.data.images) setImages(productData.data.images);
      }
