...
const PRODUCTS_LIST: ProductList = [
  {
    ...
    products: [
      ...
      },
      {
        ...
        link: "/products/lg-12000btu-inverter-split-wall",
        type: "aircon",
        is_enquiry_only: false,
        brand: "LG",
        btu_size: "12000BTU",
      ...
      },
      {
        ...
        link: "/products/daikin-24000btu-commercial-ducted",
        type: "aircon",
        is_enquiry_only: true,
        brand: "Daikin",
        btu_size: "24000BTU",
        btu_options: ["24,000 BTU/h"],
        badges: [
          {
            text: "COMMERCIAL",
            color: "#1E3A5F",
        ...
        images: [
          {
            ...
            alt: "Daikin 24000BTU Commercial Ducted System",
          },
          {
            src: "/Hero Images/Featured In section/Daikin Emura.png",
            alt: "Daikin 24000BTU Commercial Ducted System",
      ...
      },
      {
        ...
        link: "/products/samsung-9000btu-complete-package",
        type: "kit",
        is_enquiry_only: false,
        brand: "Samsung",
        btu_size: "Package",
        btu_options: ["Complete Package"],
        badges: [
          {
            text: "BUNDLE",
            color: "#1C99D6",
        ...
        images: [
          {
            src: "/Hero Images/Featured In section/MAIN  C ARD/MAIN 2.png",
            alt: "Samsung 9000BTU Complete Package",
          },
          {
            src: "/Hero Images/Featured In section/MAIN  C ARD/MAIN 2.png",
            alt: "Samsung 9000BTU Complete Package",
